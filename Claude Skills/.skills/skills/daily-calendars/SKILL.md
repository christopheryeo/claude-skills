...
description: >
  ...
  lunch hours 12pm-2pm, 30-minute gaps between meetings, and a maximum of 3 meetings per day); and meeting (returns/validates
...
4. **Daily Meeting Cap**: You accept a **maximum of 3 meetings per day**. If a day already has 3 confirmed meetings, no further meetings can be scheduled on that day
...
6. **Check daily meeting cap**: Count the number of confirmed meetings on that date. If already at 3, decline and suggest the next available day with fewer than 3 meetings.
7. **Apply the 30-min gap rule**: Ensure no meeting starts within 30 minutes of a previous meeting ending.
